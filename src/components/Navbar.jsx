  ...
  const handleSearch = (e)=>{
   ...
   return (
    <nav className='py-6 bg-slate-300 h-16 fixed w-full top-0 left-0 z-30 transition-colors duration-300'>
       ...
       <input className=' md:w-[50vw] h-12 border-2 rounded  border-black text-start' onChange={handleSearch} type="text" placeholder="Find Cars, Mobile Phones and more..." data-aut-id="searchBox" value={search} />
       <div className="bg-black p-2 rounded-r relative right-2">
        ...
        <div className='flex pt-1  sellicon'>
            <button className='border sellbutton rounded-3xl pl-2 w-20 md:w-23 border-black font-semibold relative left- h-10'><FaPlus className='absolute mt-[5px] pr-1 md:right-11 md:ml-5' size={15}/> SELL</button>
        </div>
